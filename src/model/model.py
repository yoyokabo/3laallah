...
class RWKV(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if self.deepspeed_offload:
            return deepspeed.initialize(optim_groups, lr=self.args.lr_init, betas=self.args.betas, eps=self.args.adam_eps, bias_correction=True, adamw_mode=False, weight_decay=0, amsgrad=False)
